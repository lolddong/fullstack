...
onMounted(() => {
  ...
  state.todoList.push({ id: ts + 1, todo: '공원 산책하기', completed: true })
  state.todoList.push({ id: ts + 2, todo: '공부 하기', completed: true })
  state.todoList.push({ id: ts + 3, todo: '자기', completed: true })
})
